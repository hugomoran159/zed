...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_4a5377101b100763 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 1616, function: Function { arguments: [Externref], shim_idx: 1617, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 1616, __wbg_adapter_9);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('grid_layout_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
