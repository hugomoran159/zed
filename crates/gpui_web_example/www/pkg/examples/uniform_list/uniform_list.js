...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_a03612c4bee156c1 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 1639, function: Function { arguments: [Externref], shim_idx: 1640, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 1639, __wbg_adapter_29);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('uniform_list_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
